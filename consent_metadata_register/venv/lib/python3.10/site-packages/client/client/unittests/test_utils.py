...
from errors import FunctionArgumentIsNotDictionary
sys.path.append('../')


class TestSocket:
    """
    Базовый Тестовый класс для тестирования отправки и получения,
...
class Tests(unittest.TestCase):
    ...
    def test_send_message(self):
        ...
        self.assertRaises(FunctionArgumentIsNotDictionary, send_message, test_socket, 1111)
