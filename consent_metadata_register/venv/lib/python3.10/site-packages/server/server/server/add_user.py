...
class RegisterUser(QDialog):
    ...
    def save_data(self):
        if not self.client_name.text():
            ...
            # Генерируем хэш пароля , в качестве соли будем использовать логи в нижнем регистре.
            ...
            self.messages.information(self, 'Успешно', 'Пользователь успешно зарегистрирован')
