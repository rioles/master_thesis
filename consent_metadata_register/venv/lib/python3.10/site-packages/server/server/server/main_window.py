...
sys.path.append('../')
from PyQt5.QtWidgets import QMainWindow, qApp, QAction, QApplication, QLabel, QTableView
...
class MainWindow(QMainWindow):
    def __init__(self, database, server, config):
        ...
        # Настройка геометрии основного окна, рамер окна фиксирован
    ...
    # Создаем модель и заполняем таблицу подключений
    def create_users_model(self):
        ...
        for row in list_users:
            ...
            # Убираем милисекунды из строки времени, т.к. такая точность не требуется
    ...
    # Функция вызывающая окно удаления пользователя
    def rem_user(self):
        global rem_window
