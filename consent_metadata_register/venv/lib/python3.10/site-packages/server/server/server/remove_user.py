...
class DelUserDialog(QDialog):
    ...
    # Проверяет наличие клиента в подключенных и закрывает соединение, так же удаляя его из базы
    def remove_user(self):
        ...
        # РАссылаем клиентам сообщение о необходимости обновить спровочники
