...
from message_queu.message_queue import MessageQueue

# Initialize logger
logger = get_task_logger(__name__)

# Celery app configuration
appli = Celery('update_user_data', broker='amqp://guest@localhost:5672//', backend='rpc://')
...
if __name__ == "__main__":
    ...
    r.publish_message('try_app', "consent_delete", **message)
