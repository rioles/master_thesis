...
def return_consumer_object():
    ...
    subject_name2 = os.getenv('subject_name2')
    bootstrap_server = os.getenv('bootstrap_server')
    topic_0_name = os.getenv('topic_0_name')
    ...
    client2 = SchemaClient(schema_url, subject_name2, schema_dict, schema_type)
    print(client)
    client.set_compatibility("FORWARD")
    client.register_schema()
    schema = client.get_schema_str()
    schema2 = client2.get_schema_str()
    ...
    consumer = ConsumerGroupClass(consent_validity_manager, bootstrap_server, topic_0_name, client2.schema_client, schema2) 
